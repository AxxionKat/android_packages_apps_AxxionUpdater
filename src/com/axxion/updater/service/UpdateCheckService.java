...
package com.axxion.updater.service;
...
import com.axxion.updater.R;
import com.axxion.updater.UpdateApplication;
import com.axxion.updater.UpdatesSettings;
import com.axxion.updater.misc.Constants;
import com.axxion.updater.misc.State;
import com.axxion.updater.misc.UpdateInfo;
import com.axxion.updater.receiver.DownloadReceiver;
import com.axxion.updater.utils.HttpRequestExecutor;
import com.axxion.updater.utils.Utils;
...
public class UpdateCheckService extends IntentService {
    ...
    // request actions
    public static final String ACTION_CHECK = "com.axxion.axxionupdater.action.CHECK";
    public static final String ACTION_CANCEL_CHECK = "com.axxion.axxionupdater.action.CANCEL_CHECK";

    // broadcast actions
    public static final String ACTION_CHECK_FINISHED = "com.axxion.axxionupdater.action.UPDATE_CHECK_FINISHED";
    ...
    private URI getServerURI() {
        String propertyUpdateUri = SystemProperties.get("axxion.updater.uri");
    ...
    private JSONObject buildUpdateRequest(int updateType) throws JSONException {
        ...
        params.put("device", TESTING_DOWNLOAD ? "Axxiontestdevice" : Utils.getDeviceType());
