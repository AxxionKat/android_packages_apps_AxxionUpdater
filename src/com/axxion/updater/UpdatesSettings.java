...
import com.axxion.updater.service.UpdateCheckService;
import com.axxion.updater.utils.UpdateFilter;
...
public class UpdatesSettings extends PreferenceActivity implements
    ...
    private void refreshPreferences(LinkedList<UpdateInfo> updates) {
        ...
        String installedZip = "axxion-" + Utils.getInstalledVersion() + ".zip";
